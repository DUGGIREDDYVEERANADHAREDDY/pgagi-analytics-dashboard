...
const variants = {
  fill: {
    white_A700: "bg-white-a700 shadow-xs text-blue_gray-800_04",
  },
};
const sizes = {
  xs: "h-[76px] pl-[34px] pr-2.5 text-[12px]",
};
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              width: "100%",
              backgroundColor: state.isSelected ? "#0bb5c9" : "transparent",
              color: state.isSelected ? "#ffffff" : "inherit",
              "&:hover": {
                backgroundColor: "#0bb5c9",
                color: "#ffffff",
              },
            }),
